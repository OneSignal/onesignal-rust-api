...
------------ | ------------- | ------------- | -------------
**id** | Option<**String**> | Server-assigned node UUID. Returned on reads. Required on update to keep an existing node. Rejected on create with a 400 validation error. | [optional]
