...
/// struct for typed errors of method [`copy_template_to_app`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`create_custom_events`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateCustomEventsError {
    Status400(crate::models::GenericError),
...
/// struct for typed errors of method [`create_journey`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`delete_journey`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`start_live_activity`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`update_journey`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`update_journey_node`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UpdateJourneyNodeError {
    Status400(crate::models::GenericError),
    Status403(crate::models::GenericError),
    Status404(crate::models::GenericError),
    Status409(crate::models::GenericError),
...
/// struct for typed errors of method [`update_subscription_by_token`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`view_api_keys`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`view_journey`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ViewJourneyError {
    Status404(crate::models::GenericError),
    Status429(crate::models::RateLimitError),
    DefaultResponse(crate::models::GenericError),
    UnknownValue(serde_json::Value),
...
/// struct for typed errors of method [`view_journey_stats`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ViewJourneyStatsError {
    Status404(crate::models::GenericError),
    Status429(crate::models::RateLimitError),
    DefaultResponse(crate::models::GenericError),
    UnknownValue(serde_json::Value),
...
/// struct for typed errors of method [`view_journeys`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ViewJourneysError {
    Status400(crate::models::GenericError),
    Status403(crate::models::GenericError),
    Status429(crate::models::RateLimitError),
    DefaultResponse(crate::models::GenericError),
...
/// struct for typed errors of method [`view_template`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`view_templates`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
pub async fn cancel_notification(configuration: &configuration::Configuration, app_id: &str, notification_id: &str) -> Result<crate::models::GenericSuccessBoolResponse, Error<CancelNotificationError>> {
    ...
    req_builder = req_builder.header("OS-Usage-Data", "kind=sdk, sdk-name=onesignal-rust, version=5.13.0");
...
pub async fn copy_template_to_app(configuration: &configuration::Configuration, template_id: &str, app_id: &str, copy_template_request: crate::models::CopyTemplateRequest) -> Result<crate::models::TemplateResource, Error<CopyTemplateToAppError>> {
    let configuration = configuration;

    let client = &configuration.client;

    let uri_str = format!("{}/templates/{template_id}/copy_to_app", configuration.base_path, template_id=crate::apis::urlencode(template_id));
    ...
    req_builder = req_builder.json(&copy_template_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<CopyTemplateToAppError> = serde_json::from_str(&content).ok();
        let error = ResponseContent { status: status, content: content, entity: entity };
        Err(Error::ResponseError(error))
    }
}
...
pub async fn create_api_key(configuration: &configuration::Configuration, app_id: &str, create_api_key_request: crate::models::CreateApiKeyRequest) -> Result<crate::models::CreateApiKeyResponse, Error<CreateApiKeyError>> {
    let configuration = configuration;

    let client = &configuration.client;

    let uri_str = format!("{}/apps/{app_id}/auth/tokens", configuration.base_path, app_id=crate::apis::urlencode(app_id));
    let mut req_builder = client.request(reqwest::Method::POST, uri_str.as_str());
    ...
    req_builder = req_builder.json(&create_api_key_request);
...
pub async fn create_custom_events(configuration: &configuration::Configuration, app_id: &str, custom_events_request: crate::models::CustomEventsRequest) -> Result<serde_json::Value, Error<CreateCustomEventsError>> {
    let configuration = configuration;

    let client = &configuration.client;

    let uri_str = format!("{}/apps/{app_id}/custom_events", configuration.base_path, app_id=crate::apis::urlencode(app_id));
    let mut req_builder = client.request(reqwest::Method::POST, uri_str.as_str());
    ...
    req_builder = req_builder.json(&custom_events_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<CreateCustomEventsError> = serde_json::from_str(&content).ok();
        let error = ResponseContent { status: status, content: content, entity: entity };
        Err(Error::ResponseError(error))
    }
}
...
pub async fn create_journey(configuration: &configuration::Configuration, app_id: &str, create_journey_request: crate::models::CreateJourneyRequest) -> Result<crate::models::Journey, Error<CreateJourneyError>> {
    let configuration = configuration;

    let client = &configuration.client;

    let uri_str = format!("{}/apps/{app_id}/journeys", configuration.base_path, app_id=crate::apis::urlencode(app_id));
    let mut req_builder = client.request(reqwest::Method::POST, uri_str.as_str());
    ...
    req_builder = req_builder.json(&create_journey_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<CreateJourneyError> = serde_json::from_str(&content).ok();
        let error = ResponseContent { status: status, content: content, entity: entity };
        Err(Error::ResponseError(error))
    }
}
...
pub async fn create_template(configuration: &configuration::Configuration, create_template_request: crate::models::CreateTemplateRequest) -> Result<crate::models::TemplateResource, Error<CreateTemplateError>> {
    let configuration = configuration;
    ...
    req_builder = req_builder.json(&create_template_request);
...
pub async fn delete_api_key(configuration: &configuration::Configuration, app_id: &str, token_id: &str) -> Result<serde_json::Value, Error<DeleteApiKeyError>> {
    let configuration = configuration;

    let client = &configuration.client;

    let uri_str = format!("{}/apps/{app_id}/auth/tokens/{token_id}", configuration.base_path, app_id=crate::apis::urlencode(app_id), token_id=crate::apis::urlencode(token_id));
    let mut req_builder = client.request(reqwest::Method::DELETE, uri_str.as_str());
...
pub async fn delete_journey(configuration: &configuration::Configuration, app_id: &str, journey_id: &str) -> Result<crate::models::GenericSuccessBoolResponse, Error<DeleteJourneyError>> {
    let configuration = configuration;

    let client = &configuration.client;

    let uri_str = format!("{}/apps/{app_id}/journeys/{journey_id}", configuration.base_path, app_id=crate::apis::urlencode(app_id), journey_id=crate::apis::urlencode(journey_id));
    let mut req_builder = client.request(reqwest::Method::DELETE, uri_str.as_str());
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<DeleteJourneyError> = serde_json::from_str(&content).ok();
        let error = ResponseContent { status: status, content: content, entity: entity };
        Err(Error::ResponseError(error))
    }
}
...
pub async fn delete_template(configuration: &configuration::Configuration, template_id: &str, app_id: &str) -> Result<crate::models::GenericSuccessBoolResponse, Error<DeleteTemplateError>> {
    let configuration = configuration;

    let client = &configuration.client;

    let uri_str = format!("{}/templates/{template_id}", configuration.base_path, template_id=crate::apis::urlencode(template_id));
    let mut req_builder = client.request(reqwest::Method::DELETE, uri_str.as_str());
...
pub async fn rotate_api_key(configuration: &configuration::Configuration, app_id: &str, token_id: &str) -> Result<crate::models::CreateApiKeyResponse, Error<RotateApiKeyError>> {
    let configuration = configuration;

    let client = &configuration.client;

    let uri_str = format!("{}/apps/{app_id}/auth/tokens/{token_id}/rotate", configuration.base_path, app_id=crate::apis::urlencode(app_id), token_id=crate::apis::urlencode(token_id));
    let mut req_builder = client.request(reqwest::Method::POST, uri_str.as_str());
...
pub async fn start_live_activity(configuration: &configuration::Configuration, app_id: &str, activity_type: &str, start_live_activity_request: crate::models::StartLiveActivityRequest) -> Result<crate::models::StartLiveActivitySuccessResponse, Error<StartLiveActivityError>> {
    let configuration = configuration;

    let client = &configuration.client;

    let uri_str = format!("{}/apps/{app_id}/activities/activity/{activity_type}", configuration.base_path, app_id=crate::apis::urlencode(app_id), activity_type=crate::apis::urlencode(activity_type));
    let mut req_builder = client.request(reqwest::Method::POST, uri_str.as_str());
    ...
    req_builder = req_builder.json(&start_live_activity_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<StartLiveActivityError> = serde_json::from_str(&content).ok();
        let error = ResponseContent { status: status, content: content, entity: entity };
        Err(Error::ResponseError(error))
    }
}
...
pub async fn update_api_key(configuration: &configuration::Configuration, app_id: &str, token_id: &str, update_api_key_request: crate::models::UpdateApiKeyRequest) -> Result<serde_json::Value, Error<UpdateApiKeyError>> {
    let configuration = configuration;
    ...
    req_builder = req_builder.json(&update_api_key_request);
...
pub async fn update_journey(configuration: &configuration::Configuration, app_id: &str, journey_id: &str, update_journey_request: crate::models::UpdateJourneyRequest) -> Result<crate::models::Journey, Error<UpdateJourneyError>> {
    let configuration = configuration;
    ...
    req_builder = req_builder.json(&update_journey_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<UpdateJourneyError> = serde_json::from_str(&content).ok();
        let error = ResponseContent { status: status, content: content, entity: entity };
        Err(Error::ResponseError(error))
    }
}
...
pub async fn update_journey_node(configuration: &configuration::Configuration, app_id: &str, journey_id: &str, node_id: &str, update_journey_node_request: crate::models::UpdateJourneyNodeRequest) -> Result<crate::models::Journey, Error<UpdateJourneyNodeError>> {
    let configuration = configuration;

    let client = &configuration.client;

    let uri_str = format!("{}/apps/{app_id}/journeys/{journey_id}/nodes/{node_id}", configuration.base_path, app_id=crate::apis::urlencode(app_id), journey_id=crate::apis::urlencode(journey_id), node_id=crate::apis::urlencode(node_id));
    let mut req_builder = client.request(reqwest::Method::PATCH, uri_str.as_str());
    ...
    req_builder = req_builder.json(&update_journey_node_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<UpdateJourneyNodeError> = serde_json::from_str(&content).ok();
        let error = ResponseContent { status: status, content: content, entity: entity };
        Err(Error::ResponseError(error))
    }
}
...
pub async fn update_subscription_by_token(configuration: &configuration::Configuration, app_id: &str, token_type: &str, token: &str, subscription_body: crate::models::SubscriptionBody) -> Result<serde_json::Value, Error<UpdateSubscriptionByTokenError>> {
    let configuration = configuration;

    let client = &configuration.client;

    let uri_str = format!("{}/apps/{app_id}/subscriptions_by_token/{token_type}/{token}", configuration.base_path, app_id=crate::apis::urlencode(app_id), token_type=crate::apis::urlencode(token_type), token=crate::apis::urlencode(token));
    let mut req_builder = client.request(reqwest::Method::PATCH, uri_str.as_str());
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<UpdateSubscriptionByTokenError> = serde_json::from_str(&content).ok();
        let error = ResponseContent { status: status, content: content, entity: entity };
        Err(Error::ResponseError(error))
    }
}
...
pub async fn update_template(configuration: &configuration::Configuration, template_id: &str, app_id: &str, update_template_request: crate::models::UpdateTemplateRequest) -> Result<crate::models::TemplateResource, Error<UpdateTemplateError>> {
    let configuration = configuration;
    ...
    req_builder = req_builder.json(&update_template_request);
...
pub async fn view_api_keys(configuration: &configuration::Configuration, app_id: &str) -> Result<crate::models::ApiKeyTokensListResponse, Error<ViewApiKeysError>> {
    let configuration = configuration;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<ViewApiKeysError> = serde_json::from_str(&content).ok();
        let error = ResponseContent { status: status, content: content, entity: entity };
        Err(Error::ResponseError(error))
    }
}
...
pub async fn view_journey(configuration: &configuration::Configuration, app_id: &str, journey_id: &str) -> Result<crate::models::Journey, Error<ViewJourneyError>> {
    let configuration = configuration;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<ViewJourneyError> = serde_json::from_str(&content).ok();
        let error = ResponseContent { status: status, content: content, entity: entity };
        Err(Error::ResponseError(error))
    }
}
...
pub async fn view_journey_stats(configuration: &configuration::Configuration, app_id: &str, journey_id: &str) -> Result<crate::models::JourneyStats, Error<ViewJourneyStatsError>> {
    let configuration = configuration;

    let client = &configuration.client;

    let uri_str = format!("{}/apps/{app_id}/journeys/{journey_id}/stats", configuration.base_path, app_id=crate::apis::urlencode(app_id), journey_id=crate::apis::urlencode(journey_id));
    let mut req_builder = client.request(reqwest::Method::GET, uri_str.as_str());
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<ViewJourneyStatsError> = serde_json::from_str(&content).ok();
        let error = ResponseContent { status: status, content: content, entity: entity };
        Err(Error::ResponseError(error))
    }
}
...
pub async fn view_journeys(configuration: &configuration::Configuration, app_id: &str, cursor: Option<&str>, limit: Option<i32>) -> Result<crate::models::JourneyListResponse, Error<ViewJourneysError>> {
    let configuration = configuration;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<ViewJourneysError> = serde_json::from_str(&content).ok();
        let error = ResponseContent { status: status, content: content, entity: entity };
        Err(Error::ResponseError(error))
    }
}
...
pub async fn view_template(configuration: &configuration::Configuration, template_id: &str, app_id: &str) -> Result<crate::models::TemplateResource, Error<ViewTemplateError>> {
    let configuration = configuration;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<ViewTemplateError> = serde_json::from_str(&content).ok();
        let error = ResponseContent { status: status, content: content, entity: entity };
        Err(Error::ResponseError(error))
    }
}
...
pub async fn view_templates(configuration: &configuration::Configuration, app_id: &str, limit: Option<i32>, offset: Option<i32>, channel: Option<&str>) -> Result<crate::models::TemplatesListResponse, Error<ViewTemplatesError>> {
    let configuration = configuration;
    ...
    if let Some(ref str) = channel {
        req_builder = req_builder.query(&[("channel", &str.to_string())]);
    }
    if let Some(ref user_agent) = configuration.user_agent {
        req_builder = req_builder.header(reqwest::header::USER_AGENT, user_agent.clone());
    }
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<ViewTemplatesError> = serde_json::from_str(&content).ok();
        let error = ResponseContent { status: status, content: content, entity: entity };
        Err(Error::ResponseError(error))
    }
}
